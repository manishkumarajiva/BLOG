          ...
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 my-4 w-full xl:w-1/5">
                  ...
                  <g fill="none" fillRule="evenodd">
                    <g transform="translate(0 -75)">
                      ...
                      <text fill="white" fontFamily="Nunito-Bold, Nunito" fontSize="512" fontWeight="bold">
                        <tspan x="654" y="518">Daily Blog</tspan>
                      </text>
                    </g>
                  </g>
                </svg>
              ...
              <p className="text-justify">
                Daily Blog. The UI Components gives you all of the building blocks without any annoying opinionated styles you have to fight to override.
              </p>
            </div>
